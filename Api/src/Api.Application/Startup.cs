...
namespace application
{
    public class Startup
    {
        ...
        {
            Environment.SetEnvironmentVariable("DB_CONNECTION", "Server=DESKTOP-SBS5HTT;Database=dbToDoApp;MultipleActiveResultSets=true;User ID=DEV;Password=fdsfsdklfjh!@#235!;TrustServerCertificate=True");
